...
#  cnsroot.py
#
#  Copyright (C) 2018-present Zhang Maiyun <myzhang1029@hotmail.com>
#
...
"""Print numbers that their nth root, n_2th root,... are all integers
...
class LcmAction(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        namespace.add_multiple = lcm(
            values, old) if old is not None else values
