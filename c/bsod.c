...
{
	HWND hWnd = phdc;
	char *Text[] = {"A problem has been detected and windows has been shut down to prevent damage",
			"to your computer.",
			"",
	...
	font = CreateFont(winrect.bottom / 48, winrect.right / 84, 0, 0, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS,
