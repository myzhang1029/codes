...
static void update_rtc(time_t result, uint8_t stratum) {
    // Note that we need the system time needs to be in UTC
    time_t lresult = result + TIME_CORR_SEC;
    ...
    printf("Setting RTC to %04d-%02d-%02d %d:%02d:%02d\n", dt.year, dt.month,
